...
Tests the production endpoint at /api/register/team
"""
import requests
...
try:
    print("\n📤 Sending registration request to POST /api/register/team...")
    ...
    if response.status_code in [200, 201]:
        ...
        print("\n" + "=" * 70)
        print("✅ PRODUCTION ENDPOINT FULLY FUNCTIONAL!")
        print("=" * 70)
        print("\n📋 Summary:")
        print("   ✓ Multipart form data accepted")
        print("   ✓ Sequential team ID generated and assigned")
        print("   ✓ Team record saved to database")
        print("   ✓ Captain record saved to database")
        print("   ✓ Vice-Captain record saved to database")
        print("   ✓ Ready for frontend deployment")
        print("\n🎯 Frontend Integration:")
        print("   POST http://your-backend/api/register/team")
